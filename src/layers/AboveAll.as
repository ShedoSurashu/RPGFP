package layers
{
	...
	public class AboveAll extends Entity
	{
		public var tilemap:Tilemap;
		
		public function AboveAll(map:XML,tileset:Class):void
		{
			...
			var gid:int = 0;
			for each (var tile:XML in map.layer.(@name == "AboveAll").data.tile) {
			...
			FP.log("AboveAll layer generated.");
		}
	}
}