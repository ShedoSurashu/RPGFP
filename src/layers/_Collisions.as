...
layers._Collisions
------------------
The class that defines the collision areas on a map.
...
package layers
{
	...
	public class _Collisions extends Entity
	{
		public var grid:Grid;
		
		public function _Collisions(map:XML)
		{
			// Set the type.
			type = GC.MT_COLLISION;
