package layers
{
	...
	public class AboveGround extends Entity
	{
		public var tilemap:Tilemap;
		
		public function AboveGround(map:XML,tileset:Class):void
		{
			...
			var gid:int = 0;
			for each (var tile:XML in map.layer.(@name == "AboveGround").data.tile) {
			...
			FP.log("AboveGround layer generated.");
		}
	}
}